...
/*   Updated: 2022/12/10 12:52:38 by ouidriss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static size_t	count_element_split_by(char const *s, char c)
{
	unsigned int	i;
	size_t			count;
...
static size_t	find_end(char const *s, char c, unsigned int start)
{
	unsigned int	i;
